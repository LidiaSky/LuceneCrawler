...
import robot.ch6.usecase.credit.data.users.BadUserType;
import robot.ch6.usecase.credit.data.users.DangerousUserType;
import robot.ch6.usecase.credit.data.users.ExcellentUserType;
import robot.ch6.usecase.credit.data.users.GoodUserType;
import robot.ch6.usecase.credit.data.users.User;
import robot.ch6.usecase.credit.data.users.UserType;
import robot.ch6.usecase.credit.data.users.VeryGoodUserType;
import robot.ch6.usecase.credit.util.DataGenerator;
...
public class UseCaseData {
    ...
    public static String TRAINING_USERS_FILENAME = 
        "c:/robot/data/ch06/generated-training-users.txt";
    
    public static String TEST_USERS_FILENAME = 
        "c:/robot/data/ch06/generated-test-users.txt";
	...
	public void create(boolean overwrite) {
		if (overwrite) {
			TRAINING_USERS_FILENAME = "c:/robot/data/ch06/training-users.txt";
			TEST_USERS_FILENAME = "c:/robot/data/ch06/test-users.txt";
		}		
		create();
	}
