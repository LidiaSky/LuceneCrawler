...
import robot.ch3.collaborative.data.BaseDataset;
...
public class DiggDelphi {
	...
	public static void main(String[] args) {
		BaseDataset ds = DiggData.loadData("C:/robot/data/ch03/digg_stories.csv");
		robot.ch3.collaborative.model.User user = ds.getUser(1);
