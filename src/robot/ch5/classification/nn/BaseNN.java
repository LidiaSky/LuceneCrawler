package robot.ch5.classification.nn;

import robot.ch5.classification.nn.intf.Layer;
import robot.ch5.classification.nn.intf.Link;
import robot.ch5.classification.nn.intf.NeuralNetwork;
import robot.ch5.classification.nn.intf.Node;
...
public class BaseNN implements NeuralNetwork, java.io.Serializable {
    ...
    /* (non-Javadoc)
	 * @see robot.ch5.classification.nn.NeuralNetwork#setInputLayer(robot.ch5.classification.nn.intf.Layer)
	 */
    ...
    /* (non-Javadoc)
	 * @see robot.ch5.classification.nn.NeuralNetwork#addHiddenLayer(robot.ch5.classification.nn.intf.Layer)
	 */
    ...
    /* (non-Javadoc)
	 * @see robot.ch5.classification.nn.NeuralNetwork#classify(double[])
	 */
    ...
    /* (non-Javadoc)
	 * @see robot.ch5.classification.nn.NeuralNetwork#train(double[], double[])
	 */
    ...
    /* (non-Javadoc)
	 * @see robot.ch5.classification.nn.NeuralNetwork#printWeights()
	 */
    ...
    /* (non-Javadoc)
	 * @see robot.ch5.classification.nn.NeuralNetwork#createInputLayer(int, int)
	 */
    ...
    /* (non-Javadoc)
	 * @see robot.ch5.classification.nn.NeuralNetwork#createHiddenLayer(int, int, double[])
	 */
    ...
    /* (non-Javadoc)
	 * @see robot.ch5.classification.nn.NeuralNetwork#createOutputLayer(int, int, double[])
	 */
	...
	/* (non-Javadoc)
	 * @see robot.ch5.classification.nn.NeuralNetwork#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see robot.ch5.classification.nn.NeuralNetwork#setName(java.lang.String)
	 */
    ...
    /* (non-Javadoc)
	 * @see robot.ch5.classification.nn.NeuralNetwork#getInputNodeCount()
	 */
    ...
    /* (non-Javadoc)
	 * @see robot.ch5.classification.nn.NeuralNetwork#getOutputNodeCount()
	 */
