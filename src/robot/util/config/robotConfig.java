...
public class robotConfig {
    ...
    public static final String DATA_DIR = "robot.data.dir";
    public static final String TEMP_DIR = "robot.temp.dir";
    public static final String MOVIELENS_DATA_DIR = "robot.movielens.data.dir";
    public static final String MOVIELENSTEST_DATA_DIR = "robot.ch3.movielenstest.data.dir";

    /*
     * System property name that can be used to override default properties file.
     */
    private static String systemPropertyName = "robot.configuration";

    /*
     * Default resource name that will be used to load properties.
     */
    private static String defaultResourceName = "/robot.properties";
...
//                    defaultResourceName + "'.");
        ...
        try {
            InputStream inStream = robotConfig.class.getResourceAsStream(resourceName);
